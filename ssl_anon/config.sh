...
tts_type=ssl        #TTS: Self-supervised learning features: hubert_kmeans; hubert_soft
#ssl_model=hubert_km
ssl_model=hubert_soft
xvect_type=kaldi     
#xvect_type=sidekit
...
#anon_data_suffix=_hubert_km_anon
anon_data_suffix=_hubert_soft_anon
