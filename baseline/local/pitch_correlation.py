    ...
    with ReadHelper(f'scp:{wav_list_orig}') as reader_orig:
        with ReadHelper(f'scp:{wav_list_anon}') as reader_anon:
            ...
            for utid_orig, (freq_orig, samp_orig) in reader_orig:
                ...
                assert diff < 0.025, f'Difference between lenghts of original and anonymized utterances exceeds is too long (exceeds 20ms): {utid_orig}  and {utid_anon}, difference = {diff} ms'                
