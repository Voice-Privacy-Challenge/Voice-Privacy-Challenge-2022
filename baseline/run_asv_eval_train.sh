...
if [ $xvect_type = "kaldi" ]; then
  ...
  python3 tools/sidekit_csv_from_kaldi.py --kaldi-data-path data/train_clean_360 \
  ...
  python3 egs/libri360_train/dataprep.py --from ./data/RIRS_NOISES --make-csv-augment-reverb
  python3 egs/libri360_train/dataprep.py --from ./data/musan_split --make-csv-augment-noise

  # Apply Voice Activation Detector to input data
  python3 apply_vad_on_csv.py --nj $nj \
